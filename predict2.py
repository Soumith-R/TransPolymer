...
class PolymerPredictor:
    def __init__(self, model_path: str = 'checkpoints/model_best2.pt'):
    ...
    def _load_model(self):
        ...
        try:
            ...
            self.model = PolymerDecoder(
                ...
                d_model=512,      # Increased from 512
                n_layers=8,      # Increased from 8  
                n_heads=8,       # Increased from 8
                d_ff=2048,        # Increased from 2048
    ...
    def predict_single(self, smile_string: str) -> Dict[str, float]:
        ...
        try:
            ...
            # Add confidence intervals (±5°C is typical for polymer predictions)
            predictions = {
